...
layout_ans4.addWidget(rbt_4)

layout_ans1.addLayout(layout_ans2)
layout_ans1.addLayout(layout_ans3)

RadioGroupBox.setLayaout(layout_ans1)
...
layout_line2.addWidget(btn_relax)
layout_line3.addWidget(box_Minutes)
layout_line1.addWidget(QLabel('Хвилина'))

layout_line2.addWidget(lb_Question, alignment= (Qt.AlignHCentre|Qt.AlignVCenter))
layout_line3.addWidget(radio_Group)
layout_line3.addWidget(ans_Group_Box)
layout_line4.addWidget(btn_Answer, alignment= (Qt.AlignHCentre|Qt.AlignVCenter))
...
def show_question():
    ...
    radio_Answer.setExlusive(False)
    rbtn_1.setCheck(False)
    rbtn_2.setCheck(False)
    rbtn_3.setCheck(False)
    rbtn_4.setCheck(False)
    radio_Answer.setExlusive(True)
